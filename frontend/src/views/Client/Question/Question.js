              ...
              <div className="w-full">
                <div className="w-full relative">
                  <input
                    placeholder=" "
                    {...register("name")}
                    className={`form-input border border-second dark:border-third text-second font-normal rounded-[4px] w-[100%] h-[50px] px-[20px] transition-all duration-[0.25s] focus:border-second dark:focus:border-third outline-none bg-third dark:bg-darkMode`}
                  />
                  <label
                    htmlFor="name"
