...
console.log(errors)
  return (
    <form
      ...
      autoComplete="off"
      className="flex flex-row container mx-auto mt-[40px] gap-x-[20px]"
    >
      ...
      <div className="w-[400px] h-fit bg-[#F9F9F9] border border-dashed border-[#D7D7D7] rounded">
        <h2 className="my-[20px] text-[20px] ml-[20%]">Đơn hàng của bạn</h2>
        <div className="w-[350px] mx-auto border-t border-[#CCCCCC]"></div>
        <div className="w-[350px] mx-auto ml-[20px]">
        ...
        <div className="w-[350px] mx-auto pt-[20px]">
