...
import { setOpenadminRepQuestion } from "../../../redux/adminRepQuestion/adminRepQuestionActions";
...
function QuestionToday(props) {
  ...
  const handleRep=(item)=>{
    ...
    dispatchQV(setOpenadminRepQuestion(obj));
  }

  return (
    <div className="w-full  bg-white shadow-admin rounded-[8px]">
      <div
        className={`p-[20px] flex flex-row justify-between items-center cursor-pointer rounded-[8px] ${show && "shadow-admin"
          }`}
